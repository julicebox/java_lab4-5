...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        axisStroke = new BasicStroke(0.0f, BasicStroke.CAP_BUTT,
        ...
        areaFont = new Font("Serif", Font.BOLD, 10);
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
            ...
            if (point[0] >= viewport[0][0] && point[1] <= viewport[0][1] && point[0] <= viewport[1][0]) {
                ...
                Point2D.Double corner = shiftPoint(center, 0, 0);
                boolean even = true;
    ...
    protected void paintArea(Graphics2D canvas) {
        ...
        for (; i < graphicsData.length - 2; i++) {
            ...
            if (!sign) {
                ...
                labelPos.y = (float) (highestPoint.y - highestPoint.y );
                if (Rotate) {
    ...
    protected void paintDashes(Graphics2D canvas){
        ...
        for (int i = 0; i < 11; i++) {
            ...
            canvas.drawString(plus_value_x, (float) (labelPlusPos.getX() - bounds_plus_x.getWidth() / 2),
                    (float) (labelPlusPos.getY() - bounds_plus_x.getY() - 95));
            ...
            if (i != 0) {
                ...
                canvas.drawString(minus_value_x, (float) (labelMinusPosX.getX() - bounds_minus_x.getWidth()  / 2),
                        (float) (labelMinusPosX.getY() - bounds_minus_x.getY()- 95));
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minY <= 0.0 && maxY >= 0.0) {
            ...
            arrow.lineTo(arrow.getCurrentPoint().getX() - 20,
                    arrow.getCurrentPoint().getY() - 1);
            arrow.lineTo(arrow.getCurrentPoint().getX(),
                    arrow.getCurrentPoint().getY() + 2);
            arrow.closePath();
            canvas.draw(arrow);
            canvas.fill(arrow);
